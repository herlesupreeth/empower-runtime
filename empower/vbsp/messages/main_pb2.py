...
_SINGLE_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mENB_cells', full_name='single_event.mENB_cells', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mRAN_sharing_ctrl', full_name='single_event.mRAN_sharing_ctrl', index=6,
...
_SCHEDULE_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mENB_cells', full_name='schedule_event.mENB_cells', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SINGLE_EVENT.fields_by_name['mENB_cells'].message_type = configs__pb2._ENB_CELLS
_SINGLE_EVENT.fields_by_name['mRAN_sharing_ctrl'].message_type = ran__sharing__pb2._RAN_SHARING_CTRL
...
_SINGLE_EVENT.oneofs_by_name['events'].fields.append(
  _SINGLE_EVENT.fields_by_name['mENB_cells'])
_SINGLE_EVENT.fields_by_name['mENB_cells'].containing_oneof = _SINGLE_EVENT.oneofs_by_name['events']
_SINGLE_EVENT.oneofs_by_name['events'].fields.append(
  _SINGLE_EVENT.fields_by_name['mRAN_sharing_ctrl'])
_SINGLE_EVENT.fields_by_name['mRAN_sharing_ctrl'].containing_oneof = _SINGLE_EVENT.oneofs_by_name['events']
...
_SCHEDULE_EVENT.fields_by_name['mENB_cells'].message_type = configs__pb2._ENB_CELLS
...
_SCHEDULE_EVENT.oneofs_by_name['events'].fields.append(
  _SCHEDULE_EVENT.fields_by_name['mENB_cells'])
_SCHEDULE_EVENT.fields_by_name['mENB_cells'].containing_oneof = _SCHEDULE_EVENT.oneofs_by_name['events']
